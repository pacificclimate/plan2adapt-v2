window.env = {
  ...
  REACT_APP_CELL_RULES_ENGINE_URL:
    "https://beehive.pacificclimate.org/plan2adapt/files/cell_impacts",
  REACT_APP_STATS_URL:
    "https://beehive.pacificclimate.org/plan2adapt/files/stats",
  REACT_APP_LEGEND_TYPE: "achromatic",
  REACT_APP_REGIONAL_ASSESSMENTS_URL:
    "https://beehive.pacificclimate.org/plan2adapt/files/assessments",
  REACT_APP_ENSEMBLE_NAME: "p2a_cmip6_mbcn",
  REACT_APP_MODEL_ID: "PCIC12;PCIC_BLEND_v1",
  REACT_APP_EMISSIONS_SCENARIOS:
    "historical,ssp585;historical,ssp585;historical",
